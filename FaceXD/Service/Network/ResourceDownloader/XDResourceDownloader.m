...
#define kXDResourceURLFacePredictorModel @"https://facexd-dlib-1253814426.cos.ap-chengdu.myqcloud.com/shape_predictor_68_face_landmarks.dat"
...
+ (NSURLRequest *)facePredictorModelRequest {
    ...
    [request setValue:kFACEXD_DLIB_BUCKET_REFERER forHTTPHeaderField:@"Referer"];
