...
LAppParam const LAppParamEyeRSmile = LAppParamMake(ParamEyeRSmile);
...
LAppParam const LAppParamEyeBrowLY = LAppParamMake(ParamBrowLY);
LAppParam const LAppParamEyeBrowRY = LAppParamMake(ParamBrowRY);
LAppParam const LAppParamEyeBrowLForm = LAppParamMake(ParamBrowLForm);
LAppParam const LAppParamEyeBrowRForm = LAppParamMake(ParamBrowRForm);
