...
@property (nonatomic, strong) LAppModel *model;
...
- (void)viewDidLoad {
    ...
    self.parameter = [[XDDlibModelParameterConfiguration alloc] initWithModel:self.model];
}

- (void)glkView:(GLKView *)view drawInRect:(CGRect)rect {
    [LAppOpenGLContextInstance updateTime];
    glClear(GL_COLOR_BUFFER_BIT);
    [self.model setMVPMatrixWithSize:self.screenSize];
    [self.model onUpdateWithParameterUpdate:^{
